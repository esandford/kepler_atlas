...
var drawnCircles = scene.selectAll(".spheresandcirclescircle") 	//creates a selection, which is currently empty
					.data(spheres_and_circlescircles)				//join "circles" list
          ...
          .call(makeSolid, 'gold')
                .append('sphere')
          .attr('radius', function(d){return d.sphereradius;})
...
var drawn_star = scene.selectAll(".keplerstar")
               .data(keplerstars)
                     ...
                     .append('shape')
                     .call(makeSolid, color="red", opacity = function(d){
                     ...
                     }) //uses a function to return the STeff and apply our color scale to create differences 
                     .append('sphere')
...
var drawn_planet = scene.selectAll(".keplerstar")
            				 ...
            				 .append('transform')
            				 .attr('class', 'point')
            				 .attr('translation', function(d){return 3000*d.koi_sma + ' ' + 0 + ' ' + 0;})
            				 .append('shape')

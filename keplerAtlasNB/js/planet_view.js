...
var drawn_planet = scene.selectAll(".keplerstar")
            				 ...
            				 .append('sphere')
            				 .attr('radius', function(d) {return 5*rScale(d.koi_ror * d.koi_srad)}); //draw spheres to represent points, using a function to return the radius and apply the radius scale

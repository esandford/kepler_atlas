...
function earthView() { 
				...
				viewpoint.attr("position", view_pos.join(" "))
				 ...
				 planets.attr('radius', function(d) {return 2*d.koi_srad;}); //draw spheres to represent points

				}

function galaxyView() { 
				//var view_pos = [-1677.11173, 2131.25139, -5981.29509]; //Catherine's version
				var view_pos = [-71481.90522, -19085.21779, -64575.3209463]; //Caroline's version
				var fov = 1.0;
				//var view_or = [0.72929, 0.67504, -0.11162, 3.87833]; //Catherine's version
				var view_or = [0.87137, -0.35927, -0.33412, 2.68349]; //Caroline's version
				...
				viewpoint.attr("position", view_pos.join(" "))
				  ...
				  .attr("fieldOfView", fov)
				  //.attr('centerOfRotation', "0 0 0"); //Catherine's version
				  .attr('centerOfRotation', "0 0 0"); //Caroline's version

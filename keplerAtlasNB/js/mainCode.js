...
colors = ["#9C1E1E","#D62828","#E16262","#F3C4C4","#738E9B","#45687A","#2E556A","#174259","#001F2F"];

var colorScale = d3.scale.linear()
	  .domain([2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000]) // Temperatures
	  .range(colors);//converts temperatures into colors
...
var planets = planetContainer.selectAll("g.planet")
				...
				.append("circle")
				.attr("class", "planet")
				.attr("r",function(d) {return d.koi_srad;})// d.KOI_srad KOIarchive
				//.attr("r", function(d) {return radiusSizer*d.Radius;})//rScale(d.Radius);})
				.attr("cx", function(d) {return xScale(convertXYZ(d.dist, d.ra, d.dec)[0]);})
				.attr("cy", function(d) {return yScale(convertXYZ(d.dist, d.ra, d.dec)[1]);})
				...
				//.style("fill", function(d){return "url(#gradientRadial-" + d.ID + ")";}) //what is going on here?
					.style("opacity", function(d) {
						var z = convertXYZ(d.dist, d.ra, d.dec)[2];

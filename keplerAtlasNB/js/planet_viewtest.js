...
function planetsizeView() {
        scene.selectAll(".keplerstar")
          .data(keplerstars)
                     .enter()
                     .append('transform')
                     .attr('class', 'point')
                     ...
                     .append('shape')
                     .call(makeSolid, color=function(d){return keplerstarscolorScale(d.koi_steff)}, opacity = .8)
                     .append('sphere')
          ...
          .data(keplerstars)
                     ...
                     .append('sphere')
                     .attr('radius', function(d) {return .01*rorScale(d.koi_ror * d.koi_srad)});
        }
function planetdistanceView() {
        scene.selectAll(".keplerstar")
          .data(keplerstars)
                     .enter()
                     .append('transform')
                     ...
                     .call(makeSolid, color=function(d){return keplerstarscolorScale(d.koi_steff)}, opacity = .8)
                     .append('sphere')
                     .attr('radius', function(d) {return rorScale(d.koi_srad)/215});
                     var drawn_planet = scene.selectAll(".keplerstar")
          .data(keplerstars)
                     .enter()
                     .append('transform')
                     .attr('class', 'point')
                     .attr('translation', function(d){return smaScale(d.koi_sma)/215 + ' ' + 0 + ' ' + 0;})
                     .append('shape')
                     .call(makeSolid, color=function(d){return keplerplanetcolorScale(d.koi_teq)}, opacity = 1) //uses a function to return the STeff and apply our color scale to create differences 
                     //.call(makeSolid, color="blue", opacity = 1) //uses a function to return the STeff and apply our color scale to create differences 
                     .append('sphere')
                     .attr('radius', function(d) {return .01*rorScale(d.koi_ror * d.koi_srad)/215});
